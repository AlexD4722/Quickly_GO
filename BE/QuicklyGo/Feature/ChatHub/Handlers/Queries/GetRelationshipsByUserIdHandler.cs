...
{
    public class GetRelationshipsByUserIdHandler : IRequestHandler<GetRelationshipsByUserIdQuery, IEnumerable<Relationship>>
    {
        public IGenericRepository<Relationship> _relationshipRepository;
        public GetRelationshipsByUserIdHandler(IGenericRepository<Relationship> relationshipRepository)
        {
            _relationshipRepository = relationshipRepository;
        }
        public async Task<IEnumerable<Relationship>> Handle(GetRelationshipsByUserIdQuery request, CancellationToken cancellationToken)
        {
